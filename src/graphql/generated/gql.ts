 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation AssignChairOrSecretary($assignChairOrSecretaryToFapInput: AssignChairOrSecretaryToFapInput!) {\n  assignChairOrSecretary(\n    assignChairOrSecretaryToFapInput: $assignChairOrSecretaryToFapInput\n  ) {\n    id\n  }\n}"): typeof import('./graphql').AssignChairOrSecretaryDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
